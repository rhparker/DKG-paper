...
The spectrum of the kink-antikink is similarly computed ({fig:kakspec}, left panel). As predicted by the theory, each element of the point spectrum splits into two eigenvalues. The eigenfunctions corresponding to the split Goldstone modes resemble two copies of the Goldstone eigenfunction of the primary kink, spliced together both in-phase and out-of-phase ({fig:kakspec}, center panel). A similar phenomenon occurs with the split edge mode eigenfunctions ({fig:kakspec}, right panel).
