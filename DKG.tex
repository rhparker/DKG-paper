...
\begin{figure}[H]
	...
	\end{tabular}
	\end{center}
	\caption{Left panel shows timestepping of perturbation primary kink solution, where two central nodes of kink are perturbed by 0.1 in same direction. Center and right panels shows difference between perturbed solution and kink for the two central nodes for perturbation of central nodes in same direction (center) and opposite direction (right) by 0.1. $d = 0.5$, timestepping using 4th order Runge-Kutta method, step size 0.04.} 
