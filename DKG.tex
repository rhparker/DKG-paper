...
\end{equation}
In particular, there is a gap in the continuous spectrum $i\left(-\sqrt{f'(S^+)},\sqrt{f'(S^+)}\right)$ which contains the origin. The continuous spectrum will be the same for the linearization about any equilibrium solution \revisedd{involving the asymptotics of $u \rightarrow \pm u^*$.}
...
%This assumption is proved in the next section.
