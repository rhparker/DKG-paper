...
For a kink-antikink, the two Goldstone mode eigenfunctions suggest that there will be two normal modes of oscillations for the central nodes of the two kinks: an in-phase mode and an out-of-phase mode. These can be seen in \cref{fig:kaktimestep}.

\begin{figure}[H]
	\begin{center}
	\begin{tabular}{cc}
	\includegraphics[width=5cm]{kakoscG1.eps} &
	\includegraphics[width=5cm]{kakoscG2.eps} 
	\end{tabular}
	\end{center}
