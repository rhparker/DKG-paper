...
% \revisedd{PGK: Do you mean that we will only consider the plus here?? Or did I misunderstand something?}
...
\begin{figure}
	...
	see also the inset discerning between the two. The eigenfunctions corresponding to the split Goldstone modes are shown in the bottom left panel. Energy difference \cref{eq:H} between the evolution of the perturbed on-site kink-antikink $u(n,t)$ and the inter-site kink-antikink $u_2(n)$. 
